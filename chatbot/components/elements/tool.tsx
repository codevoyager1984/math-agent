...
const getStatusBadge = (status: ToolUIPart['state'], t: (key: string) => string) => {
  const labels = {
    'input-streaming': t('tool.pending'),
    'input-available': t('tool.running'),
    'output-available': t('tool.completed'),
    'output-error': t('tool.error'),
  } as const;
